...
$vagrantBoxIP = "192.168.33.20"
$vagrantHosts = "yii2.local admin.yii2.local api.yii2.local"
$vagrantBoxName = "yii2-boilerplate-box"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", path: "2ambox/01----provision.sh", privileged: false
  ...
  config.vm.provision "shell", path: "2ambox/09----configure-local-environment.sh", run: "always", privileged: false
